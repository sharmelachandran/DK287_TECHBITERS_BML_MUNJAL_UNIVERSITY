...
public class frecall extends AppCompatActivity implements ConnectivityRecevier.ConnectivityRecevierListener {
    TextView W1,W2,W3;
    Button S1,F,T,H;
    ...
    void hint2(){
        new TTFancyGifDialog.Builder(frecall.this)
                .setTitle("Mic")
            ...
            case REQUEST_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (ss.equals(str[0].toLowerCase()) && flag0 == 0) {
                        ...
                        flag0 = 1;
                        W1.setText("Carrot");
                    } else if (ss.equals(str[1].toLowerCase()) && flag1 == 0) {ccout++;
                        Toast.makeText(getApplicationContext(), "SUPER!!!"+ss+" is correct", Toast.LENGTH_LONG).show();
                        flag1 = 1;
                        W2.setText("Banana");

                    } else if (ss.equals(str[2].toLowerCase()) && flag2 == 0) {ccout++;
