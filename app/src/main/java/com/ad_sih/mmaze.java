...
public class mmaze extends AppCompatActivity implements ConnectivityRecevier.ConnectivityRecevierListener{
    Button p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,H,tim;
    Button w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w15,w16,w17,w18,w19,w20,w21,w22,w23,w24,w25,w26,w27,w28,w29,w30;
    ImageView c,m,c1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mmaze);
        ...
        p0=findViewById(R.id.v5);
        p1=findViewById(R.id.v15);
        p2=findViewById(R.id.v16);
        p3=findViewById(R.id.v17);
        p4=findViewById(R.id.v27);
        p5=findViewById(R.id.v37);
        p6=findViewById(R.id.v47);
        p7=findViewById(R.id.v46);
        p8=findViewById(R.id.v45);
        p9=findViewById(R.id.v44);
        p10=findViewById(R.id.v43);
        p11=findViewById(R.id.v33);
        p12=findViewById(R.id.v32);
        p13=findViewById(R.id.v31);
        p14=findViewById(R.id.v41);
        p15=findViewById(R.id.v51);
        p16=findViewById(R.id.v61);
        p17=findViewById(R.id.v71);
        p18=findViewById(R.id.v81);
        p19=findViewById(R.id.v91);
        p20=findViewById(R.id.v92);
        p21=findViewById(R.id.v93);
        p22=findViewById(R.id.v83);
        p23=findViewById(R.id.v84);
        p24=findViewById(R.id.v85);
        p25=findViewById(R.id.v86);
        p26=findViewById(R.id.v96);
        p27=findViewById(R.id.v106);
        p28=findViewById(R.id.v116);
        p29=findViewById(R.id.v126);
        w1=findViewById(R.id.v18);
        w2=findViewById(R.id.v19);
        w3=findViewById(R.id.v29);
        w4=findViewById(R.id.v39);
        w5=findViewById(R.id.v49);
        w6=findViewById(R.id.v59);
        w7=findViewById(R.id.v35);
        w8=findViewById(R.id.v54);
        w9=findViewById(R.id.v64);
        w10=findViewById(R.id.v65);
        w11=findViewById(R.id.v23);
        w12=findViewById(R.id.v13);
        w13=findViewById(R.id.v12);
        w14=findViewById(R.id.v11);
        w15=findViewById(R.id.v62);
        w16=findViewById(R.id.v102);
        w17=findViewById(R.id.v112);
        w18=findViewById(R.id.v111);
        w19=findViewById(R.id.v113);
        w20=findViewById(R.id.v114);
        w21=findViewById(R.id.v87);
        w22=findViewById(R.id.v77);
        w23=findViewById(R.id.v67);
        w24=findViewById(R.id.v88);
        w25=findViewById(R.id.v89);
        w26=findViewById(R.id.v79);
        w27=findViewById(R.id.v98);
        w28=findViewById(R.id.v108);
        w29=findViewById(R.id.v118);
        w30=findViewById(R.id.v119);
        ...
        builder = new GuideView.Builder(this)
                ...
                .setGuideListener(new GuideListener() {
                    ...
                    public void onDismiss(View view) {
                        switch (view.getId()) {
                            case R.id.time:
                                builder.setTitle("Task").setContentText("Help me to reach Circus Stage\nclear maze by block by block").setTargetView(v2).build();
                                break;
                            case R.id.imgc:
                                startTimer();
                                return;
        ...
        tv.setText("Please Guide me to reach the Circus Stage!!");
    ...
    void hint(){
        new TTFancyGifDialog.Builder(mmaze.this)
                .setTitle("Instruction")
                .setMessage("Guide the clown to reach the circus stage\nClear the maze by clicking\nblock by block")
                .setPositiveBtnText("GOT IT")
                .setPositiveBtnBackground("#22b573")
                .setGifResource(R.drawable.mmazeinstruction)      //pass your gif, png or jpg
                .isCancellable(false)
