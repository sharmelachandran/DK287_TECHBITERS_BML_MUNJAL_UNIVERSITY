...
public class fnumbercross extends AppCompatActivity implements ConnectivityRecevier.ConnectivityRecevierListener {
    Button b1,H,tim;
   // ProgressBar progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fnumbercross);
        //prog();
        Arrays.fill(a,0);
        Arrays.fill(flag,0);
    ...
    private void changeActivity(){
        ...
        this.onPause();
        i.putExtra("activity","fnumbercross");
        startActivity(i);
    }
    @Override
