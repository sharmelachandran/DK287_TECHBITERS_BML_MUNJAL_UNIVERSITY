...
public class carrow extends AppCompatActivity implements ConnectivityRecevier.ConnectivityRecevierListener {
    ImageButton r,l,u,d;
    TextView tv;
    Button F,H,tim;
    int c=0;
    ...
    String arr[]={"Click RIGHT Arrow","Click LEFT Arrow","Click UP Arrow","Click DOWN Arrow","Click RIGHT Arrow","Click DOWN Arrow","Click UP Arrow","Click LEFT Arrow","Click DOWN Arrow","Click RIGHT Arrow"};
        ...
        l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((flag1 == 0 || flag1==1||flag1==2) && i<10) {
                    final Animation animation= AnimationUtils.loadAnimation(carrow.this,R.anim.pluse);
                    ...
                    if(j<10)
                        ...
                        tv.setText("FINISH");F.setVisibility(View.VISIBLE);}
                }
            }
        });
