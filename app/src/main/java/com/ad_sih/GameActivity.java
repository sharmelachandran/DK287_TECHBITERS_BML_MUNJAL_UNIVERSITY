...
//import com.nirfinz.memorygame.MemoryButton;
//import com.nirfinz.memorygame.Timer;
...
public class GameActivity extends AppCompatActivity implements  View.OnClickListener {
    ...
    private  com.ad_sih.MemoryButton[] allButtons;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // initForTimer(numOfSeconds + 1, timer_txt);
        ...
        this.allButtons = new com.ad_sih.MemoryButton[numOfElements];
...
*/
    ...
    private void helperForMenu(){m.stop();
