...
public class home extends AppCompatActivity implements ConnectivityRecevier.ConnectivityRecevierListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(level==1)
        {
            ...
            Runnable r1=new Runnable() {
                @Override
                public void run() {
                    b1.setBackgroundResource(R.drawable.n1);
                    f1=1;
                    startanim(b1);
                }
            };
            ...
            Runnable r1=new Runnable() {
                @Override
                public void run() {
                    b2.setBackgroundResource(R.drawable.n2);
                    startanim(b2);
                    f2=1;
                }
            };
            ...
            Runnable r1=new Runnable() {
                @Override
                public void run() {
                    b3.setBackgroundResource(R.drawable.n3);
                    startanim(b3);
                    f3=1;
                }
            };
            ...
            Runnable r1=new Runnable() {
                @Override
                public void run() {
                    b4.setBackgroundResource(R.drawable.n4);
                    startanim(b4);
                    f4=1;
                }
            };
            ...
            Runnable r1=new Runnable() {
                @Override
                public void run() {
                    b5.setBackgroundResource(R.drawable.n5);
                    startanim(b5);
                    f5=1;
                }
            };
            ...
            b3.setBackgroundResource(R.drawable.n3);f3=2;
            b4.setBackgroundResource(R.drawable.n4);f4=2;
            b5.setBackgroundResource(R.drawable.n5);f5=2;
            Runnable r1=new Runnable() {
                @Override
                public void run() {
                    b6.setBackgroundResource(R.drawable.n6);
                    startanim(b6);
                    f6=1;
                }
            };
            ...
            b4.setBackgroundResource(R.drawable.n4);f4=2;
            b5.setBackgroundResource(R.drawable.n5);f5=2;
            b6.setBackgroundResource(R.drawable.n6);f6=2;
            Runnable r1=new Runnable() {
                @Override
                public void run() {
                    b7.setBackgroundResource(R.drawable.n7);
                    startanim(b7);
                    f7=1;
                }
            };
            ...
            b5.setBackgroundResource(R.drawable.n5);f5=2;
            b6.setBackgroundResource(R.drawable.n6);f6=2;
            b7.setBackgroundResource(R.drawable.n7);f7=2;
            Runnable r1=new Runnable() {
                @Override
                public void run() {
                    b8.setBackgroundResource(R.drawable.n8);
                    startanim(b8);
                    f8=1;
                }
            };
            ...
            b6.setBackgroundResource(R.drawable.n6);f6=2;
            b7.setBackgroundResource(R.drawable.n7);f7=2;
            b8.setBackgroundResource(R.drawable.n8);f8=2;
            Runnable r1=new Runnable() {
                @Override
                public void run() {
                    b9.setBackgroundResource(R.drawable.n9);
                    startanim(b9);
                    f9=1;
                }
            };
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f1==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(), Nature.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f2==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(), nmaze.class);
                    startActivity(i);finish();
                }else if(f2==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f4==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),jumble2.class);
                    startActivity(i);finish();
                }else if(f4==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f5==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),nrecall.class);
                    startActivity(i);finish();
                }else if(f5==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f6==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),arrow.class);
                    startActivity(i);finish();
                }else if(f6==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f7==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),numbercross.class);
                    startActivity(i);finish();
                }else if(f7==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f9==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),nobject.class);
                    startActivity(i);finish();
                }else if(f9==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void storedata(){
        ...
        register.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                register.child("Nature").child("MMSE").child("Orientation").setValue(s[0]);
                register.child("Nature").child("AD_Finder").child("Orientation").setValue(s[0]);
                s[0]=((5-s[0])*8)/5;
                register.child("Nature").child("ADAS").child("Orientation").setValue(s[0]);
            }
