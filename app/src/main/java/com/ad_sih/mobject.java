...
public class mobject extends AppCompatActivity implements ConnectivityRecevier.ConnectivityRecevierListener{
    TextView girl,gun,ticket,w1,w2,w3;
    TextView t1,t2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ticket=findViewById(R.id.textView8);
        w1=findViewById(R.id.textView10);
        w2=findViewById(R.id.textView12);
        w3=findViewById(R.id.textView13);
    ...
    private void storedata(){
        ...
        final DatabaseReference register = firebaseDatabase.getReference().child(FirebaseAuth.getInstance().getUid()).child("Entertainment");
