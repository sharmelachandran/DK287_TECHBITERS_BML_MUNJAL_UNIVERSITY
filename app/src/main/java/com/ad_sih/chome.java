...
public class chome extends AppCompatActivity implements ConnectivityRecevier.ConnectivityRecevierListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(level==1)
        {
            ...
            b3.setBackgroundResource(R.drawable.s3);f3=2;
            b4.setBackgroundResource(R.drawable.s4);f4=2;
            b5.setBackgroundResource(R.drawable.s5);f5=2;
            ...
            b4.setBackgroundResource(R.drawable.s4);f4=2;
            b5.setBackgroundResource(R.drawable.s5);f5=2;
            b6.setBackgroundResource(R.drawable.s6);f6=2;
            Runnable r1=new Runnable() {
                @Override
                public void run() {
            ...
            b5.setBackgroundResource(R.drawable.s5);f5=2;
            b6.setBackgroundResource(R.drawable.s6);f6=2;
            b7.setBackgroundResource(R.drawable.s7);f7=2;
            Runnable r1=new Runnable() {
                @Override
                public void run() {
            ...
            b6.setBackgroundResource(R.drawable.s6);f6=2;
            b7.setBackgroundResource(R.drawable.s7);f7=2;
            b8.setBackgroundResource(R.drawable.s8);f8=2;
            Runnable r1=new Runnable() {
                @Override
                public void run() {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f1==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(), Cricket.class);
                    startActivity(i);
                    finish();
                }
                if(f1==2){
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f2==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(), cmaze.class);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f4==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),cjumble.class);
                    startActivity(i);finish();
                }else if(f4==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f5==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),crecall.class);
                    startActivity(i);finish();
                }else if(f5==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f6==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),carrow.class);
                    startActivity(i);finish();
                }else if(f6==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f7==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),cnumbercross.class);
                    startActivity(i);finish();
                }else if(f7==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f9==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),coject.class);
                    startActivity(i);finish();
                }else if(f9==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
    ...
    protected void onStop() {
        unregisterReceiver(connectivityRecevier);super.onStop();
    }
    ...
    private void storedata(){
        ...
        register.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                register.child("Sports").child("MMSE").child("Orientation").setValue(s[0]);
                register.child("Sports").child("AD_Finder").child("Orientation").setValue(s[0]);
                s[0]=((5-s[0])*8)/5;
                register.child("Sports").child("ADAS").child("Orientation").setValue(s[0]);
            }
