...
public class mhome extends AppCompatActivity implements ConnectivityRecevier.ConnectivityRecevierListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f1==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(), Flim.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f2==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(), mmaze.class);
                    startActivity(i);unregisterReceiver(connectivityRecevier);finish();
                }else if(f2==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        /*b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f3==1) {
                    ...
                    i.putExtra("theme","entertainment");
                    startActivity(i);unregisterReceiver(connectivityRecevier);finish();
                }else if(f3==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f4==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),mjumble.class);
                    startActivity(i);unregisterReceiver(connectivityRecevier);finish();
                }else if(f4==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f5==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),mrecall.class);
                    startActivity(i);unregisterReceiver(connectivityRecevier);finish();
                }else if(f5==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f6==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),marrow.class);
                    startActivity(i);unregisterReceiver(connectivityRecevier);finish();
                }else if(f6==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f7==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),mnumbercross.class);
                    startActivity(i);unregisterReceiver(connectivityRecevier);finish();
                }else if(f7==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
        ...
        b9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f9==1) {
                    ring.pause();
                    Intent i = new Intent(getApplicationContext(),mobject.class);
                    startActivity(i);unregisterReceiver(connectivityRecevier);finish();
                }else if(f9==2){
                    Toast.makeText(getApplicationContext(),"Level Completed",Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void storedata(){
        ...
        register.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                register.child("Entertainment").child("MMSE").child("Orientation").setValue(s[0]);
                register.child("Entertainment").child("AD_Finder").child("Orientation").setValue(s[0]);
                s[0]=((5-s[0])*8)/5;
                register.child("Entertainment").child("ADAS").child("Orientation").setValue(s[0]);
            }
