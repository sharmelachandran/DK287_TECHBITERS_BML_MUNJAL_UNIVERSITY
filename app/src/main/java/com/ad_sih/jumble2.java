...
public class jumble2 extends AppCompatActivity implements ConnectivityRecevier.ConnectivityRecevierListener{
                ...
                switch (dragEvent){
                    ...
                    case DragEvent.ACTION_DROP:
                        ...
                        if(view.getId() ==R.id.s1 || view.getId()==R.id.textView1)
                        {
                            ...
                            C1.setBackgroundResource(R.drawable.j2);
                        ...
                        else if(view.getId()==R.id.textView2 || view.getId()==R.id.s2)
                        {
                            ...
                            C1.setBackgroundResource(R.drawable.j3);
                            view.animate().x(C1.getX()).y(C1.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView3 || view.getId()==R.id.s3)
                        {
                            ...
                            C1.setBackgroundResource(R.drawable.j1);
                            view.animate().x(C1.getX()).y(C1.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView4 || view.getId()==R.id.s4)
                        {
                            ...
                            C1.setBackgroundResource(R.drawable.j5);
                            view.animate().x(C1.getX()).y(C1.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView5 || view.getId()==R.id.s5)
                        {
                            ...
                            C1.setBackgroundResource(R.drawable.j4);
                            view.animate().x(C1.getX()).y(C1.getY()).setDuration(700).start();
                        }
                        if(wcount+ccount==5) {
                ...
                switch (dragEvent){
                    ...
                    case DragEvent.ACTION_DROP:
                        ...
                        if(view.getId() ==R.id.s1 || view.getId()==R.id.textView1)
                        {
                            ...
                            t1.setText("");
                            S1.setBackgroundResource(R.color.grass);
                            C2.setBackgroundResource(R.drawable.j2);
                        ...
                        else if(view.getId()==R.id.textView2 || view.getId()==R.id.s2)
                        {
                            ...
                            t2.setText("");
                            S2.setBackgroundResource(R.color.grass);
                            C2.setBackgroundResource(R.drawable.j3);
                            view.animate().x(C2.getX()).y(C2.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView3 || view.getId()==R.id.s3)
                        {
                            ...
                            t3.setText("");
                            S3.setBackgroundResource(R.color.grass);
                            C2.setBackgroundResource(R.drawable.j1);
                            view.animate().x(C2.getX()).y(C2.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView4 || view.getId()==R.id.s4)
                        {
                            ...
                            t4.setText("");
                            S4.setBackgroundResource(R.color.grass);
                            C2.setBackgroundResource(R.drawable.j5);
                            view.animate().x(C2.getX()).y(C2.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView5 || view.getId()==R.id.s5)
                        {
                            ...
                            t5.setText("");
                            S5.setBackgroundResource(R.color.grass);
                            C2.setBackgroundResource(R.drawable.j4);
                            view.animate().x(C2.getX()).y(C2.getY()).setDuration(700).start();
                        }
                        if(wcount+ccount==5) {
                            F.setVisibility(View.VISIBLE);
                ...
                switch (dragEvent){
                    ...
                    case DragEvent.ACTION_DROP:
                        ...
                        if(view.getId() ==R.id.s1 || view.getId()==R.id.textView1)
                        {
                            ...
                            t1.setText("");
                            S1.setBackgroundResource(R.color.grass);
                            C3.setBackgroundResource(R.drawable.j2);
                        ...
                        else if(view.getId()==R.id.textView2 || view.getId()==R.id.s2)
                        {
                            ...
                            t2.setText("");
                            S2.setBackgroundResource(R.color.grass);
                            C3.setBackgroundResource(R.drawable.j3);
                            view.animate().x(C3.getX()).y(C3.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView3 || view.getId()==R.id.s3)
                        {
                            ...
                            t3.setText("");
                            S3.setBackgroundResource(R.color.grass);
                            C3.setBackgroundResource(R.drawable.j1);
                            view.animate().x(C3.getX()).y(C3.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView4 || view.getId()==R.id.s4)
                        {
                            ...
                            t4.setText("");
                            S4.setBackgroundResource(R.color.grass);
                            C3.setBackgroundResource(R.drawable.j5);
                            view.animate().x(C3.getX()).y(C3.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView5 || view.getId()==R.id.s5)
                        {
                            ...
                            t5.setText("");
                            S5.setBackgroundResource(R.color.grass);
                            C3.setBackgroundResource(R.drawable.j4);
                            view.animate().x(C3.getX()).y(C3.getY()).setDuration(700).start();
                        }
                        if(wcount+ccount==5) {
                            F.setVisibility(View.VISIBLE);
                ...
                switch (dragEvent){
                    ...
                    case DragEvent.ACTION_DROP:
                        ...
                        if(view.getId() ==R.id.s1 || view.getId()==R.id.textView1)
                        {
                            ...
                            t1.setText("");
                            S1.setBackgroundResource(R.color.grass);
                            C4.setBackgroundResource(R.drawable.j2);
                        ...
                        else if(view.getId()==R.id.textView2 || view.getId()==R.id.s2)
                        {
                            ...
                            t2.setText("");
                            S2.setBackgroundResource(R.color.grass);
                            C4.setBackgroundResource(R.drawable.j3);
                            view.animate().x(C4.getX()).y(C4.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView3 || view.getId()==R.id.s3)
                        {
                            ...
                            t3.setText("");
                            S3.setBackgroundResource(R.color.grass);
                            C4.setBackgroundResource(R.drawable.j1);
                            view.animate().x(C4.getX()).y(C4.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView4 || view.getId()==R.id.s4)
                        {
                            ...
                            t4.setText("");
                            S4.setBackgroundResource(R.color.grass);
                            C4.setBackgroundResource(R.drawable.j5);
                            view.animate().x(C4.getX()).y(C4.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView5 || view.getId()==R.id.s5)
                        {
                            ...
                            t5.setText("");
                            S5.setBackgroundResource(R.color.grass);
                            C4.setBackgroundResource(R.drawable.j4);
                            view.animate().x(C4.getX()).y(C4.getY()).setDuration(700).start();
                        }
                        if(wcount+ccount==5) {
                            F.setVisibility(View.VISIBLE);
                ...
                switch (dragEvent){
                    ...
                    case DragEvent.ACTION_DROP:
                        ...
                        if(view.getId() ==R.id.s1 || view.getId()==R.id.textView1)
                        {
                            ...
                            t1.setText("");
                            S1.setBackgroundResource(R.color.grass);
                            C5.setBackgroundResource(R.drawable.j2);
                        ...
                        else if(view.getId()==R.id.textView2 || view.getId()==R.id.s2)
                        {
                            ...
                            t2.setText("");
                            S2.setBackgroundResource(R.color.grass);
                            C5.setBackgroundResource(R.drawable.j3);
                            view.animate().x(C5.getX()).y(C5.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView3 || view.getId()==R.id.s3)
                        {
                            ...
                            t3.setText("");
                            S3.setBackgroundResource(R.color.grass);
                            C5.setBackgroundResource(R.drawable.j1);
                            view.animate().x(C5.getX()).y(C5.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView4 || view.getId()==R.id.s4)
                        {
                            ...
                            t4.setText("");
                            S4.setBackgroundResource(R.color.grass);
                            C5.setBackgroundResource(R.drawable.j5);
                            view.animate().x(C5.getX()).y(C5.getY()).setDuration(700).start();
                        }
                        else if(view.getId()==R.id.textView5 || view.getId()==R.id.s5)
                        {
                            ...
                            t5.setText("");
                            S5.setBackgroundResource(R.color.grass);
                            C5.setBackgroundResource(R.drawable.j4);
                            view.animate().x(C5.getX()).y(C5.getY()).setDuration(700).start();
                        }
                        if(wcount+ccount==5) {
                            F.setVisibility(View.VISIBLE);
